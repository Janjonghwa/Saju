...
export async function POST() {
  ...
  try {
    ...
    await prisma.$executeRaw`
      CREATE TABLE IF NOT EXISTS "BirthProfile" (
        "id" TEXT NOT NULL,
        "userId" TEXT NOT NULL,
    ...
    await prisma.$executeRaw`
      CREATE INDEX IF NOT EXISTS "BirthProfile_userId_idx" ON "BirthProfile"("userId");
    `;
    ...
    await prisma.$executeRaw`
      CREATE INDEX IF NOT EXISTS "Report_birthProfileId_idx" ON "Report"("birthProfileId");
    `;

    await prisma.$executeRaw`
      CREATE INDEX IF NOT EXISTS "Report_theme_idx" ON "Report"("theme");
    `;
    ...
    await prisma.$executeRaw`
      CREATE INDEX IF NOT EXISTS "ReportLog_reportId_idx" ON "ReportLog"("reportId");
    `;

    await prisma.$executeRaw`
      CREATE TABLE IF NOT EXISTS "InterpretationMessage" (
        "id" TEXT NOT NULL,
        "theme" TEXT NOT NULL,
    ...
    await prisma.$executeRaw`
      CREATE INDEX IF NOT EXISTS "InterpretationMessage_theme_category_tag_priority_idx" ON "InterpretationMessage"("theme", "category", "tag", "priority");
    `;
    ...
    await prisma.$executeRaw`
      ALTER TABLE "BirthProfile" DROP CONSTRAINT IF EXISTS "BirthProfile_userId_fkey";
    ...
    await prisma.$executeRaw`
      ALTER TABLE "Report" DROP CONSTRAINT IF EXISTS "Report_birthProfileId_fkey";
    ...
    await prisma.$executeRaw`
      ALTER TABLE "ReportLog" DROP CONSTRAINT IF EXISTS "ReportLog_reportId_fkey";
